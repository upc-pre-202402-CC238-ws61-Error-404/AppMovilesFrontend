// app/src/main/java/com/example/chaquitaclla_appmovil_android/crops_details/adapters/ProductAdapter.kt
...
class ProductAdapter(private val products: List<Product>, private val onEditClick: (Product) -> Unit, private val onDeleteClick: (Product) -> Unit) : RecyclerView.Adapter<ProductAdapter.ProductViewHolder>() {
